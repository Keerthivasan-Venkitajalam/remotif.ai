      ...
      <div className="bg-light min-h-screen">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div className="md:w-1/2 md:pl-8">
                ...
                Remotif.AI is a cutting-edge healthcare management system
                ...
                <p className="text-gray-600 mb-4 text-[1.1rem] font-montserrat">
                  With Remotif.AI, you can easily manage appointments, access
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                {
                  name: "John Doe",
                  text: "Remotif.AI has revolutionized how I manage my healthcare. It's so easy to use!",
         
                },
                {
                  name: "Jane Smith",
                  text: "I love how I can access all my medical information in one place. Great job, Remotif.AI!",
           
                },
                {
                  name: "Mike Johnson",
                  text: "Booking appointments has never been easier. Remotif.AI  is a game-changer!",
        ...
        <section className="cta bg-primary text-light py-20 rounded-3xl mx-4 mb-4">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="mb-8">
              Join Remotif.AI today and experience the future of healthcare
              management.
            </p>
            <Link to="/signup">
              <motion.button
